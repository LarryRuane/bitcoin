...
static void CoinSelection(benchmark::Bench& bench)
{
    ...
    for (const auto& wtx : wtxs) {
        ...
        available_coins.GetCoinsByType(OutputType::BECH32).emplace_back(COutPoint(wtx->GetHash(), 0), txout, /*depth=*/6 * 24, CalculateMaximumSignedInputSize(txout, &wallet, /*coin_control=*/nullptr), /*spendable=*/true, /*solvable=*/true, /*safe=*/true, wtx->GetTxTime(), /*from_me=*/true, /*fees=*/ 0);
    }
