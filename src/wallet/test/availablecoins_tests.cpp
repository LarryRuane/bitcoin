...
BOOST_FIXTURE_TEST_CASE(BasicOutputTypesTest, AvailableCoinsTestingSetup)
{
    ...
    BOOST_CHECK_EQUAL(available_coins.GetCoinsByType(OutputType::UNKNOWN).size(), 1U);
    ...
    available_coins = AvailableCoins(*wallet);
    BOOST_CHECK_EQUAL(available_coins.GetCoinsByType(OutputType::BECH32M).size(), 2U);
    ...
    available_coins = AvailableCoins(*wallet);
    BOOST_CHECK_EQUAL(available_coins.GetCoinsByType(OutputType::BECH32).size(), 2U);
    ...
    available_coins = AvailableCoins(*wallet);
    BOOST_CHECK_EQUAL(available_coins.GetCoinsByType(OutputType::P2SH_SEGWIT).size(), 2U);
    ...
    available_coins = AvailableCoins(*wallet);
    BOOST_CHECK_EQUAL(available_coins.GetCoinsByType(OutputType::LEGACY).size(), 2U);
}
